...
// api/create-income-statement.js
var { GristDocAPI } = require_dist();
var GRIST_URL = "http://localhost:8484/api";
var LeaseEndOrgName = "Lease End - Finance";
var IncomeStatementWorkspaceName = "Income Statement";
var BalanceSheetWorkspaceName = "Balance Sheet";
var CashFlowWorkspaceName = "Cash Flow";
var HomeWorkspaceName = "Home";
var IncomeStatementDocName = "Income Statement";
var initializeGristAPI = () => {
  return new GristDocAPI({ server: GRIST_URL });
};
var getOrCreateOrg = async (api) => {
  const org = await api.getOrgByName({ name: LeaseEndOrgName });
  console.log("[Found org]", org);
  await api.setOrgId(org.id);
  return org;
};
var cleanupHomeWorkspace = async (api, orgId) => {
...
var getOrCreateWorkspace = async (api, orgId, workspaceName) => {
...
var createFinancialWorkspaces = async (api, orgId) => {
  const workspaces = {
...
var getOrCreateDocument = async (api, workspaceId, docName) => {
...
var createIncomeStatementTable = async (api, docId) => {
...
var addSampleIncomeData = async (api, tableName) => {
...
//# sourceMappingURL=create-income-statement.js.map
